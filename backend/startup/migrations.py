...
async def _ensure_columns():
    ...
    stmts = [
        ...
        # AuditLog migrations live in main.py's lifespan instead — that block
        # uses SAVEPOINT per statement so an earlier failure here can't abort
        # the whole transaction and silently skip these ones.
