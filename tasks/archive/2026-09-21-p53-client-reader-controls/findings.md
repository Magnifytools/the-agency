...
- Revisión posterior: al revocar escritura con un autosave de contexto pendiente hay que restaurar el valor persistido, además de cancelar el temporizador; los diálogos de borrado también deben cerrarse visualmente al revocar el permiso.
