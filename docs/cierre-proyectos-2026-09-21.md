...
Evidencia actual: suite backend conjunta, 1.323 aprobadas y 2 omitidas (240,26 s); suites dirigidas de cierre, permisos, concurrencia, Undo y rechazo de estado nulo. La comprobación adicional con el generador real acredita cero ocurrencias durante el cierre, una al reabrir, ninguna duplicada tras otro ciclo y conservación de pausas. La revisión posterior añadió mensajes de Deshacer sin objetos JSON en avisos y una prueba transversal de semana completa: 15 pruebas dirigidas de Undo y una semanal aprobadas. Frontend congelado: 409 pruebas en 65 archivos, TypeScript y Vite correctos. Pendientes: navegador aislado, CI sobre la revisión final y despliegue.
